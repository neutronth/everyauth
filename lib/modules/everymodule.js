...
EveryModule.prototype.stepseq = function (name, description) {
  ...
  this._currSeq = seqs[name] || (seqs[name] = StepSequence(name, this, this.everyauth.debug));
  return this;
};
...
EveryModule.prototype.submodule = function (name) {
  ...
  for (var i = 0, l = listeners.length; i < l; i++) {
    submodule.once('setup', listeners[i]);
  }
...
EveryModule.prototype.halt = function () {
  return Step.prototype.HALT;
};
...
['get', 'post'].forEach( function (httpMethod) {
  EveryModule.prototype[httpMethod] = function (alias, description) {
    ...
    this._currSeq =
      this._stepSequences[name] || (this._stepSequences[name] = StepSequence(name, this, this.everyauth.debug));
    return this;
  };
});
